# KB-13 | POST-PAYMENT SEQUENCE — DPM DIVING NUSA PENIDA
...
> ⚠️ NP office hours **corrected to 7am–7pm** (previously said 6pm).
> All other KBs that still say "6pm" should be updated to match.
...
## MESSAGE 2 — Booking confirmation (NP)

> NP office hours: **7am to 7pm**.
...
## MESSAGE 3 — SSI App (NP)

> NP training centre number: **741448 / DPM Diving Nusa Penida**.
...
## MESSAGE 4 — Ferry (NP — uses 12go.asia)
